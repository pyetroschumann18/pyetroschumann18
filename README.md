<!-- Pyetro Schumann — GitHub Profile -->
...
## 💜 Currently building — MOV Digital

<table>
  <tr>
    <td width="100%" valign="top">
      <h3>🚀 Digital experiences built for real businesses</h3>
      <p>
        <strong>MOV Digital</strong> is a web development initiative focused on helping small businesses and entrepreneurs build a clear, professional and effective digital presence. The goal is to transform each client's positioning, services and ideas into fast, accessible and conversion-focused web experiences.
      </p>
      <p>
        Projects include responsive institutional websites and landing pages, reusable interface components, strategic calls to action, contact and lead-capture flows, database integrations, business automations, deployment and continuous improvements in accessibility, SEO and performance.
      </p>
      <p>
        The stack combines <strong>TypeScript, React, Astro, Tailwind CSS, Node.js, Supabase, PostgreSQL and Vercel</strong>, selected according to each project's needs and expected scale.
      </p>
      <p>
        I work across the full development cycle: requirements and solution structure, UX/UI decisions, frontend and backend implementation, data integration, testing, optimization and production delivery.
      </p>
    </td>
  </tr>
</table>
...
<p align="center">
  <img src="https://img.shields.io/badge/Responsive_UI-0D1117?style=for-the-badge&logo=css3&logoColor=B27CF4" alt="Responsive interfaces" />
  <img src="https://img.shields.io/badge/Data_Integration-0D1117?style=for-the-badge&logo=supabase&logoColor=3ECF8E" alt="Data integration" />
  <img src="https://img.shields.io/badge/Automation-0D1117?style=for-the-badge&logo=n8n&logoColor=EA4B71" alt="Business automation" />
  <img src="https://img.shields.io/badge/Performance-0D1117?style=for-the-badge&logo=lighthouse&logoColor=F44B21" alt="Web performance" />
</p>
